...
Liferay.Loader.define("chart-1$babel-helper-replace-supers@6.24.1/lib/index", ['module', 'exports', 'require', 'chart-1$babel-runtime/helpers/classCallCheck', 'chart-1$babel-runtime/core-js/symbol', 'chart-1$babel-helper-optimise-call-expression', 'chart-1$babel-messages', 'chart-1$babel-types'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var ReplaceSupers = function () {
      ...
      ReplaceSupers.prototype.getLooseSuperProperty = function getLooseSuperProperty(id, parent) {
        ...
        if (parent.property === id) {} else if (t.isCallExpression(parent, { callee: id })) {} else if (t.isMemberExpression(parent) && !methodNode.static) {
