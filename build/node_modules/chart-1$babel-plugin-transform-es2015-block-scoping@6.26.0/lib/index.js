...
Liferay.Loader.define("chart-1$babel-plugin-transform-es2015-block-scoping@6.26.0/lib/index", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/symbol', 'chart-1$babel-runtime/core-js/object/create', 'chart-1$babel-runtime/helpers/classCallCheck', 'chart-1$babel-traverse', './tdz', 'chart-1$babel-types', 'chart-1$lodash/values', 'chart-1$lodash/extend', 'chart-1$babel-template'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _values = require("chart-1$lodash/values");

    var _values2 = _interopRequireDefault(_values);

    var _extend = require("chart-1$lodash/extend");
