...
Liferay.Loader.define("chart-1$babel-plugin-transform-es2015-parameters@6.24.1/lib/default", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/get-iterator', 'chart-1$babel-helper-get-function-arity', 'chart-1$babel-helper-call-delegate', 'chart-1$babel-template', 'chart-1$babel-types'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _babelHelperGetFunctionArity = require("chart-1$babel-helper-get-function-arity");

    var _babelHelperGetFunctionArity2 = _interopRequireDefault(_babelHelperGetFunctionArity);

    var _babelHelperCallDelegate = require("chart-1$babel-helper-call-delegate");
