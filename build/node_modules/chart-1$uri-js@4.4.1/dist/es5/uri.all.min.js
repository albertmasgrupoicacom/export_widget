Liferay.Loader.define("chart-1$uri-js@4.4.1/dist/es5/uri.all.min", ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    !function (e, r) {
      ...
      "use strict";
      function r() {
        for (var e = arguments.length, r = Array(e), n = 0; n < e; n++) r[n] = arguments[n];if (r.length > 1) {
          r[0] = r[0].slice(0, -1);for (var t = r.length - 1, o = 1; o < t; ++o) r[o] = r[o].slice(1, -1);return r[t] = r[t].slice(1), r.join("");
        }return r[0];
      }function n(e) {
        return "(?:" + e + ")";
      }function t(e) {
        ...
        var n = e;if (r) for (var t in r) n[t] = r[t];return n;
      }function u(e) {
        var t = r("[0-9]", "[A-Fa-f]"),
        ...
        for (var r = "", n = 0, t = e.length; n < t;) {
          var o = parseInt(e.substr(n + 1, 2), 16);if (o < 128) r += String.fromCharCode(o), n += 3;else if (o >= 194 && o < 224) {
            if (t - n >= 6) {
              var a = parseInt(e.substr(n + 4, 2), 16);r += String.fromCharCode((31 & o) << 6 | 63 & a);
            } else r += e.substr(n, 6);n += 6;
          } else if (o >= 224) {
            if (t - n >= 9) {
              var i = parseInt(e.substr(n + 4, 2), 16),
                  u = parseInt(e.substr(n + 7, 2), 16);r += String.fromCharCode((15 & o) << 12 | (63 & i) << 6 | 63 & u);
            } else r += e.substr(n, 9);n += 9;
          } else r += e.substr(n, 3), n += 3;
        }return r;
      }function l(e, r) {
        function n(e) {
          var n = d(e);return n.match(r.UNRESERVED) ? n : e;
        ...
        var n = e.match(r.IPV4ADDRESS) || [],
            t = T(n, 2),
            o = t[1];return o ? o.split(".").map(m).join(".") : e;
      }function v(e, r) {
        var n = e.match(r.IPV6ADDRESS) || [],
            t = T(n, 3),
            o = t[1],
            a = t[2];if (o) {
          for (var i = o.toLowerCase().split("::").reverse(), u = T(i, 2), s = u[0], f = u[1], c = f ? f.split(":").map(m) : [], p = s.split(":").map(m), h = r.IPV4ADDRESS.test(p[p.length - 1]), d = h ? 7 : 8, l = p.length - d, v = Array(d), E = 0; E < d; ++E) v[E] = c[E] || p[l + E] || "";h && (v[d - 1] = g(v[d - 1], r));var C = v.reduce(function (e, r, n) {
            if (!r || "0" === r) {
              var t = e[e.length - 1];t && t.index + t.length === n ? t.length++ : e.push({ index: n, length: 1 });
            }return e;
          }, []),
              y = C.sort(function (e, r) {
            return r.length - e.length;
          })[0],
              S = void 0;if (y && y.length > 1) {
            var A = v.slice(0, y.index),
                D = v.slice(y.index + y.length);S = A.join(":") + "::" + D.join(":");
          } else S = v.join(":");return a && (S += "%" + a), S;
        }return e;
      }function E(e) {
        var r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            n = {},
            t = !1 !== r.iri ? R : F;"suffix" === r.reference && (e = (r.scheme ? r.scheme + ":" : "") + "//" + e);var o = e.match(K);if (o) {
        ...
        var n = !1 !== r.iri ? R : F,
            t = [];return e.userinfo !== undefined && (t.push(e.userinfo), t.push("@")), e.host !== undefined && t.push(v(g(String(e.host), n), n).replace(n.IPV6ADDRESS, function (e, r, n) {
          return "[" + r + (n ? "%25" + n : "") + "]";
        ...
        for (var r = []; e.length;) if (e.match(X)) e = e.replace(X, "");else if (e.match(ee)) e = e.replace(ee, "/");else if (e.match(re)) e = e.replace(re, "/"), r.pop();else if ("." === e || ".." === e) e = "";else {
          var n = e.match(ne);if (!n) throw new Error("Unexpected dot segment condition");var t = n[0];e = e.slice(t.length), r.push(t);
        }return r.join("");
      }function S(e) {
        var r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            n = r.iri ? R : F,
            t = [],
            o = J[(r.scheme || e.scheme || "").toLowerCase()];if (o && o.serialize && o.serialize(e, r), e.host) if (n.IPV6ADDRESS.test(e.host)) ;else if (r.domainHost || o && o.domainHost) try {
        ...
        }l(e, n), "suffix" !== r.reference && e.scheme && (t.push(e.scheme), t.push(":"));var a = C(e, r);if (a !== undefined && ("suffix" !== r.reference && t.push("//"), t.push(a), e.path && "/" !== e.path.charAt(0) && t.push("/")), e.path !== undefined) {
          var i = e.path;r.absolutePath || o && o.absolutePath || (i = y(i)), a === undefined && (i = i.replace(/^\/\//, "/%2F")), t.push(i);
        ...
        var r = d(e);return r.match(he) ? r : e;
      }var F = u(!1),
          R = u(!0),
          T = function () {
        function e(e, r) {
          ...
          _ = function (e) {
        if (Array.isArray(e)) {
          for (var r = 0, n = Array(e.length); r < e.length; r++) n[r] = e[r];return n;
        }return Array.from(e);
      },
          P = 2147483647,
          q = /^xn--/,
        ...
        return e + 22 + 75 * (e < 26) - ((0 != r) << 5);
          ...
          k = function (e, r, n) {
        var t = 0;for (e = n ? z(e / 700) : e >> 1, e += z(e / r); e > 455; t += 36) e = z(e / 35);return z(t + 36 * e / (e + 38));
      },
          Z = function (e) {
        var r = [],
            n = e.length,
            ...
            o = 128,
            a = 72,
            i = e.lastIndexOf("-");i < 0 && (i = 0);for (var u = 0; u < i; ++u) e.charCodeAt(u) >= 128 && s("not-basic"), r.push(e.charCodeAt(u));for (var f = i > 0 ? i + 1 : 0; f < n;) {
          for (var c = t, p = 1, h = 36;; h += 36) {
            f >= n && s("invalid-input");var d = M(e.charCodeAt(f++));(d >= 36 || d > z((P - t) / p)) && s("overflow"), t += d * p;var l = h <= a ? 1 : h >= a + 26 ? 26 : h - a;if (d < l) break;var m = 36 - l;p > z(P / m) && s("overflow"), p *= m;
          }var g = r.length + 1;a = k(t - c, g, 0 == c), z(t / g) > P - o && s("overflow"), o += z(t / g), t %= g, r.splice(t++, 0, o);
        }return String.fromCodePoint.apply(String, r);
      },
          G = function (e) {
        var r = [];e = p(e);var n = e.length,
            t = 128,
            o = 0,
            a = 72,
            i = !0,
          ...
          for (var c, h = e[Symbol.iterator](); !(i = (c = h.next()).done); i = !0) {
            var d = c.value;d < 128 && r.push(L(d));
          }
        } catch (U) {
          u = !0, f = U;
        } finally {
          ...
          }var D = m + 1;g - t > z((P - o) / D) && s("overflow"), o += (g - t) * D, t = g;var w = !0,
              b = !1,
              x = undefined;try {
            for (var O, N = e[Symbol.iterator](); !(w = (O = N.next()).done); w = !0) {
              var I = O.value;if (I < t && ++o > P && s("overflow"), I == t) {
                for (var F = o, R = 36;; R += 36) {
                  var T = R <= a ? 1 : R >= a + 26 ? 26 : R - a;if (F < T) break;var _ = F - T,
                      q = 36 - T;r.push(L(V(T + _ % q, 0))), F = z(_ / q);
          ...
          B = { version: "2.1.0", ucs2: { decode: p, encode: function (e) {
            return String.fromCodePoint.apply(String, _(e));
          } }, decode: Z, encode: G, toASCII: function (e) {
          ...
          re = /^\/\.\.(\/|$)/,
          ne = /^\/?(?:.|\n)*?(?=\/|$)/,
          te = { scheme: "http", domainHost: !0, parse: function (e, r) {
          return e.host || (e.error = e.error || "HTTP URIs must have a host."), e;
        }, serialize: function (e, r) {
          var n = "https" === String(e.scheme).toLowerCase();return e.port !== (n ? 443 : 80) && "" !== e.port || (e.port = undefined), e.path || (e.path = "/"), e;
        } },
          oe = { scheme: "https", domainHost: te.domainHost, parse: te.parse, serialize: te.serialize },
          ae = { scheme: "ws", domainHost: !0, parse: function (e, r) {
          var n = e;return n.secure = N(n), n.resourceName = (n.path || "/") + (n.query ? "?" + n.query : ""), n.path = undefined, n.query = undefined, n;
        }, serialize: function (e, r) {
          if (e.port !== (N(e) ? 443 : 80) && "" !== e.port || (e.port = undefined), "boolean" == typeof e.secure && (e.scheme = e.secure ? "wss" : "ws", e.secure = undefined), e.resourceName) {
            var n = e.resourceName.split("?"),
                t = T(n, 2),
                o = t[0],
                a = t[1];e.path = o && "/" !== o ? o : undefined, e.query = a, e.resourceName = undefined;
          ...
          ve = { scheme: "mailto", parse: function (e, r) {
          var n = e,
              t = n.to = n.path ? n.path.split(",") : [];if (n.path = undefined, n.query) {
            for (var o = !1, a = {}, i = n.query.split("&"), u = 0, s = i.length; u < s; ++u) {
              var f = i[u].split("=");switch (f[0]) {case "to":
                  for (var c = f[1].split(","), p = 0, h = c.length; p < h; ++p) t.push(c[p]);break;case "subject":
                  n.subject = O(f[1], r);break;case "body":
                  n.body = O(f[1], r);break;default:
                  o = !0, a[O(f[0], r)] = O(f[1], r);}
            }o && (n.headers = a);
          }n.query = undefined;for (var d = 0, l = t.length; d < l; ++d) {
            var m = t[d].split("@");if (m[0] = O(m[0]), r.unicodeSupport) m[1] = O(m[1], r).toLowerCase();else try {
          ...
          }var d = e.headers = e.headers || {};e.subject && (d.subject = e.subject), e.body && (d.body = e.body);var l = [];for (var m in d) d[m] !== ue[m] && l.push(m.replace(de, I).replace(de, o).replace(me, h) + "=" + d[m].replace(de, I).replace(de, o).replace(me, h));return l.length && (n.query = l.join("&")), n;
        } },
          Ee = /^([^\:]+)\:(.*)/,
          Ce = { scheme: "urn", parse: function (e, r) {
          var n = e.path && e.path.match(Ee),
            ...
            var o = r.scheme || t.scheme || "urn",
                ...
                i = n[2],
                u = o + ":" + (r.nid || a),
                s = J[u];t.nid = a, t.nss = i, t.path = undefined, s && (t = s.parse(t, r));
          } else t.error = t.error || "URN can not be parsed.";return t;
        }, serialize: function (e, r) {
          var n = r.scheme || e.scheme || "urn",
              t = e.nid,
              o = n + ":" + (r.nid || t),
              a = J[o];a && (e = a.serialize(e, r));var i = e,
              u = e.nss;return i.path = (t || r.nid) + ":" + u, i;
        } },
          ye = /^[0-9A-Fa-f]{8}(?:\-[0-9A-Fa-f]{4}){3}\-[0-9A-Fa-f]{12}$/,
          Se = { scheme: "urn:uuid", parse: function (e, r) {
          var n = e;return n.uuid = n.nss, n.nss = undefined, r.tolerant || n.uuid && n.uuid.match(ye) || (n.error = n.error || "UUID is not valid."), n;
        }, serialize: function (e, r) {
          var n = e;return n.nss = (e.uuid || "").toLowerCase(), n;
        } };J[te.scheme] = te, J[oe.scheme] = oe, J[ae.scheme] = ae, J[ie.scheme] = ie, J[ve.scheme] = ve, J[Ce.scheme] = Ce, J[Se.scheme] = Se, e.SCHEMES = J, e.pctEncChar = h, e.pctDecChars = d, e.parse = E, e.removeDotSegments = y, e.serialize = S, e.resolveComponents = A, e.resolve = function D(e, r, n) {
        var t = i({ scheme: "null" }, n);return S(A(E(e, t), E(r, t), t, !0), t);
      }, e.normalize = function w(e, r) {
        return "string" == typeof e ? e = S(E(e, r), r) : "object" === t(e) && (e = E(S(e, r), r)), e;
      }, e.equal = function b(e, r, n) {
        return "string" == typeof e ? e = S(E(e, n), n) : "object" === t(e) && (e = S(e, n)), "string" == typeof r ? r = S(E(r, n), n) : "object" === t(r) && (r = S(r, n)), e === r;
      }, e.escapeComponent = function x(e, r) {
        return e && e.toString().replace(r && r.iri ? R.ESCAPE : F.ESCAPE, h);
      }, e.unescapeComponent = O, Object.defineProperty(e, "__esModule", { value: !0 });
    });
