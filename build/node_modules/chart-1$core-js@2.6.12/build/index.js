Liferay.Loader.define('chart-1$core-js@2.6.12/build/index', ['module', 'exports', 'require', '../library/fn/promise', './config', 'chart-1$fs', 'chart-1$path', 'chart-1$webpack', 'chart-1$temp'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    (function () {
      ...
      ref$ = require('chart-1$fs'), readFile = ref$.readFile, writeFile = ref$.writeFile, unlink = ref$.unlink;
      ref$ = require('chart-1$path'), basename = ref$.basename, dirname = ref$.dirname, join = ref$.join;
      webpack = require('chart-1$webpack');
      temp = require('chart-1$temp');
