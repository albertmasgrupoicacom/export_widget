Liferay.Loader.define("chart-1$core-js@2.6.12/client/core.min", ['module', 'exports', 'require'], function (module, exports, require) {
      ...
      !function (r) {
        ...
        var _ = r(19),
          ...
          var h = 1 == l,
            ...
            for (var e, i, o = x(t), u = S(o), c = _(n, r, 3), f = m(u.length), a = 0, s = h ? b(t, f) : 2 == l ? b(t, 0) : Jt; a < f; a++) if ((5 == l || y || a in u) && (i = c(e = u[a], a, o), l)) if (h) s[a] = i;else if (i) switch (l) {case 3:
                return !0;case 5:
                return e;case 6:
                return a;case 2:
                s.push(e);} else if (g) return !1;return y ? -1 : 3 == l || g ? g : s;
          };
        };
      }, function (t, n, r) {
        var e = r(100),
        ...
        if (r(6)) {
          var y = r(32),
            ...
            var h = t + ((o = !!o) ? "Clamped" : "") + "Array",
                ...
                v = function (t, i) {
              G(t, i, { get: function () {
                  return (t = this._d).v["get" + t](i * l + t.o, Pt);var t;
                }, set: function (t) {
                  return n = i, r = t, e = this._d, o && (r = (r = Math.round(r)) < 0 ? 0 : 255 < r ? 255 : 255 & r), void e.v["set" + t](n * l + e.o, r, Pt);var n, r, e;
                }, enumerable: !0 });
