Liferay.Loader.define('chart-1$core-js@2.6.12/client/core', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    !function (__e, __g, undefined) {
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        module.exports = function (TYPE, $create) {
          ...
          return function ($this, callbackfn, that) {
            ...
            var index = 0;
            var result = IS_MAP ? create($this, length) : TYPE == 2 ? create($this, 0) : undefined;
            var val, res;
            for (; length > index; index++) if (TYPE == 5 || IS_FIND_INDEX || index in self) {
              val = self[index];
              res = f(val, index, O);
              if (TYPE) {
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        if (UPDATES_LAST_INDEX_WRONG || NPCG_INCLUDED) {
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        ({})[__webpack_require__(5)('toStringTag')] = 'z';
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        var Enumerate = function (iterated) {
          ...
          for (var key in iterated) keys.push(key);
        };
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        for (var collections = getKeys(DOMIterables), i = 0; i < collections.length; i++) {
          ...
          if (proto) {
            ...
            if (explicit) for (var key in $iterators) if (!proto[key]) redefine(proto, key, $iterators[key], true);
          }
        }
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        $export($export.S, 'Dict', {
          ...
          reduce: function reduce(object, mapfn, init) {
            aFunction(mapfn);
            var O = toIObject(object);
            var keys = getKeys(O);
            var length = keys.length;
          ...
          keyOf: keyOf,
          includes: function includes(object, el) {
            // eslint-disable-next-line no-self-compare
