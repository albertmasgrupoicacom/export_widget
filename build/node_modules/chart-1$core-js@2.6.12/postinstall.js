Liferay.Loader.define('chart-1$core-js@2.6.12/postinstall', ['module', 'exports', 'require', 'chart-1$fs', 'chart-1$os', 'chart-1$path'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    /* eslint-disable max-len */
    var fs = require('chart-1$fs');
    var os = require('chart-1$os');
    var path = require('chart-1$path');
    var env = process.env;
