...
Liferay.Loader.define("chart-1$babel-traverse@6.26.0/lib/path/index", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/get-iterator', 'chart-1$babel-runtime/helpers/classCallCheck', './lib/virtual-types', 'chart-1$debug', 'chart-1$invariant', '../index', 'chart-1$lodash/assign', '../scope', 'chart-1$babel-types', '../cache', './ancestry', './inference', './replacement', './evaluation', './conversion', './introspection', './context', './removal', './modification', './family', './comments'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _debug2 = require("chart-1$debug");

    var _debug3 = _interopRequireDefault(_debug2);

    var _invariant = require("chart-1$invariant");
    ...
    var _assign = require("chart-1$lodash/assign");
