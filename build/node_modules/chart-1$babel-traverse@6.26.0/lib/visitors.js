...
Liferay.Loader.define("chart-1$babel-traverse@6.26.0/lib/visitors", ['module', 'exports', 'require', 'chart-1$babel-runtime/helpers/typeof', 'chart-1$babel-runtime/core-js/object/keys', 'chart-1$babel-runtime/core-js/get-iterator', './path/lib/virtual-types', 'chart-1$babel-messages', 'chart-1$babel-types', 'chart-1$lodash/clone'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    exports.__esModule = true;

    var _typeof2 = require("chart-1$babel-runtime/helpers/typeof");
