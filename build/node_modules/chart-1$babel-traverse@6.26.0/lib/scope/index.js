...
Liferay.Loader.define("chart-1$babel-traverse@6.26.0/lib/scope/index", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/object/keys', 'chart-1$babel-runtime/core-js/object/create', 'chart-1$babel-runtime/core-js/map', 'chart-1$babel-runtime/helpers/classCallCheck', 'chart-1$babel-runtime/core-js/get-iterator', 'chart-1$lodash/includes', 'chart-1$lodash/repeat', './lib/renamer', '../index', 'chart-1$lodash/defaults', 'chart-1$babel-messages', './binding', 'chart-1$globals', 'chart-1$babel-types', '../cache'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    exports.__esModule = true;

    var _keys = require("chart-1$babel-runtime/core-js/object/keys");

    var _keys2 = _interopRequireDefault(_keys);

    var _create = require("chart-1$babel-runtime/core-js/object/create");

    var _create2 = _interopRequireDefault(_create);

    var _map = require("chart-1$babel-runtime/core-js/map");

    var _map2 = _interopRequireDefault(_map);

    var _classCallCheck2 = require("chart-1$babel-runtime/helpers/classCallCheck");

    var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);

    var _getIterator2 = require("chart-1$babel-runtime/core-js/get-iterator");

    var _getIterator3 = _interopRequireDefault(_getIterator2);

    var _includes = require("chart-1$lodash/includes");

    var _includes2 = _interopRequireDefault(_includes);

    var _repeat = require("chart-1$lodash/repeat");
    ...
    var _defaults = require("chart-1$lodash/defaults");

    var _defaults2 = _interopRequireDefault(_defaults);

    var _babelMessages = require("chart-1$babel-messages");
    ...
    var _globals = require("chart-1$globals");
