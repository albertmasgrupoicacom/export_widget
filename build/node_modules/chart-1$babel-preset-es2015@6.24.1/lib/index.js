...
Liferay.Loader.define("chart-1$babel-preset-es2015@6.24.1/lib/index", ['module', 'exports', 'require', 'chart-1$babel-plugin-transform-es2015-template-literals', 'chart-1$babel-plugin-transform-es2015-literals', 'chart-1$babel-plugin-transform-es2015-function-name', 'chart-1$babel-plugin-transform-es2015-arrow-functions', 'chart-1$babel-plugin-transform-es2015-block-scoped-functions', 'chart-1$babel-plugin-transform-es2015-classes', 'chart-1$babel-plugin-transform-es2015-object-super', 'chart-1$babel-plugin-transform-es2015-shorthand-properties', 'chart-1$babel-plugin-transform-es2015-duplicate-keys', 'chart-1$babel-plugin-transform-es2015-computed-properties', 'chart-1$babel-plugin-transform-es2015-for-of', 'chart-1$babel-plugin-transform-es2015-sticky-regex', 'chart-1$babel-plugin-transform-es2015-unicode-regex', 'chart-1$babel-plugin-check-es2015-constants', 'chart-1$babel-plugin-transform-es2015-spread', 'chart-1$babel-plugin-transform-es2015-parameters', 'chart-1$babel-plugin-transform-es2015-destructuring', 'chart-1$babel-plugin-transform-es2015-block-scoping', 'chart-1$babel-plugin-transform-es2015-typeof-symbol', 'chart-1$babel-plugin-transform-es2015-modules-commonjs', 'chart-1$babel-plugin-transform-es2015-modules-systemjs', 'chart-1$babel-plugin-transform-es2015-modules-amd', 'chart-1$babel-plugin-transform-es2015-modules-umd', 'chart-1$babel-plugin-transform-regenerator'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    exports.__esModule = true;

    var _babelPluginTransformEs2015TemplateLiterals = require("chart-1$babel-plugin-transform-es2015-template-literals");

    var _babelPluginTransformEs2015TemplateLiterals2 = _interopRequireDefault(_babelPluginTransformEs2015TemplateLiterals);

    var _babelPluginTransformEs2015Literals = require("chart-1$babel-plugin-transform-es2015-literals");

    var _babelPluginTransformEs2015Literals2 = _interopRequireDefault(_babelPluginTransformEs2015Literals);

    var _babelPluginTransformEs2015FunctionName = require("chart-1$babel-plugin-transform-es2015-function-name");

    var _babelPluginTransformEs2015FunctionName2 = _interopRequireDefault(_babelPluginTransformEs2015FunctionName);

    var _babelPluginTransformEs2015ArrowFunctions = require("chart-1$babel-plugin-transform-es2015-arrow-functions");

    var _babelPluginTransformEs2015ArrowFunctions2 = _interopRequireDefault(_babelPluginTransformEs2015ArrowFunctions);

    var _babelPluginTransformEs2015BlockScopedFunctions = require("chart-1$babel-plugin-transform-es2015-block-scoped-functions");
    ...
    var _babelPluginTransformEs2015Classes = require("chart-1$babel-plugin-transform-es2015-classes");

    var _babelPluginTransformEs2015Classes2 = _interopRequireDefault(_babelPluginTransformEs2015Classes);

    var _babelPluginTransformEs2015ObjectSuper = require("chart-1$babel-plugin-transform-es2015-object-super");

    var _babelPluginTransformEs2015ObjectSuper2 = _interopRequireDefault(_babelPluginTransformEs2015ObjectSuper);

    var _babelPluginTransformEs2015ShorthandProperties = require("chart-1$babel-plugin-transform-es2015-shorthand-properties");
    ...
    var _babelPluginTransformEs2015DuplicateKeys = require("chart-1$babel-plugin-transform-es2015-duplicate-keys");

    var _babelPluginTransformEs2015DuplicateKeys2 = _interopRequireDefault(_babelPluginTransformEs2015DuplicateKeys);

    var _babelPluginTransformEs2015ComputedProperties = require("chart-1$babel-plugin-transform-es2015-computed-properties");

    var _babelPluginTransformEs2015ComputedProperties2 = _interopRequireDefault(_babelPluginTransformEs2015ComputedProperties);

    var _babelPluginTransformEs2015ForOf = require("chart-1$babel-plugin-transform-es2015-for-of");

    var _babelPluginTransformEs2015ForOf2 = _interopRequireDefault(_babelPluginTransformEs2015ForOf);

    var _babelPluginTransformEs2015StickyRegex = require("chart-1$babel-plugin-transform-es2015-sticky-regex");

    var _babelPluginTransformEs2015StickyRegex2 = _interopRequireDefault(_babelPluginTransformEs2015StickyRegex);

    var _babelPluginTransformEs2015UnicodeRegex = require("chart-1$babel-plugin-transform-es2015-unicode-regex");

    var _babelPluginTransformEs2015UnicodeRegex2 = _interopRequireDefault(_babelPluginTransformEs2015UnicodeRegex);

    var _babelPluginCheckEs2015Constants = require("chart-1$babel-plugin-check-es2015-constants");

    var _babelPluginCheckEs2015Constants2 = _interopRequireDefault(_babelPluginCheckEs2015Constants);

    var _babelPluginTransformEs2015Spread = require("chart-1$babel-plugin-transform-es2015-spread");

    var _babelPluginTransformEs2015Spread2 = _interopRequireDefault(_babelPluginTransformEs2015Spread);

    var _babelPluginTransformEs2015Parameters = require("chart-1$babel-plugin-transform-es2015-parameters");

    var _babelPluginTransformEs2015Parameters2 = _interopRequireDefault(_babelPluginTransformEs2015Parameters);

    var _babelPluginTransformEs2015Destructuring = require("chart-1$babel-plugin-transform-es2015-destructuring");

    var _babelPluginTransformEs2015Destructuring2 = _interopRequireDefault(_babelPluginTransformEs2015Destructuring);

    var _babelPluginTransformEs2015BlockScoping = require("chart-1$babel-plugin-transform-es2015-block-scoping");

    var _babelPluginTransformEs2015BlockScoping2 = _interopRequireDefault(_babelPluginTransformEs2015BlockScoping);

    var _babelPluginTransformEs2015TypeofSymbol = require("chart-1$babel-plugin-transform-es2015-typeof-symbol");

    var _babelPluginTransformEs2015TypeofSymbol2 = _interopRequireDefault(_babelPluginTransformEs2015TypeofSymbol);

    var _babelPluginTransformEs2015ModulesCommonjs = require("chart-1$babel-plugin-transform-es2015-modules-commonjs");

    var _babelPluginTransformEs2015ModulesCommonjs2 = _interopRequireDefault(_babelPluginTransformEs2015ModulesCommonjs);

    var _babelPluginTransformEs2015ModulesSystemjs = require("chart-1$babel-plugin-transform-es2015-modules-systemjs");

    var _babelPluginTransformEs2015ModulesSystemjs2 = _interopRequireDefault(_babelPluginTransformEs2015ModulesSystemjs);

    var _babelPluginTransformEs2015ModulesAmd = require("chart-1$babel-plugin-transform-es2015-modules-amd");

    var _babelPluginTransformEs2015ModulesAmd2 = _interopRequireDefault(_babelPluginTransformEs2015ModulesAmd);

    var _babelPluginTransformEs2015ModulesUmd = require("chart-1$babel-plugin-transform-es2015-modules-umd");

    var _babelPluginTransformEs2015ModulesUmd2 = _interopRequireDefault(_babelPluginTransformEs2015ModulesUmd);

    var _babelPluginTransformRegenerator = require("chart-1$babel-plugin-transform-regenerator");
    ...
    function preset(context) {
      ...
      if (modules !== false && ["commonjs", "amd", "umd", "systemjs"].indexOf(modules) === -1) {
