...
Liferay.Loader.define('chart-1$loader-utils@2.0.4/lib/interpolateName', ['module', 'exports', 'require', 'chart-1$path', 'chart-1$emojis-list', './getHashDigest'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    const path = require('chart-1$path');
    const emojisList = require('chart-1$emojis-list');
...
//# sourceMappingURL=interpolateName.js.map