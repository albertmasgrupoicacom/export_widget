...
Liferay.Loader.define("chart-1$babel-plugin-transform-es2015-classes@6.24.1/lib/loose", ['module', 'exports', 'require', 'chart-1$babel-runtime/helpers/classCallCheck', 'chart-1$babel-runtime/helpers/possibleConstructorReturn', 'chart-1$babel-runtime/helpers/inherits', 'chart-1$babel-helper-function-name', './vanilla', 'chart-1$babel-types'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _possibleConstructorReturn2 = require("chart-1$babel-runtime/helpers/possibleConstructorReturn");

    var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);

    var _inherits2 = require("chart-1$babel-runtime/helpers/inherits");

    var _inherits3 = _interopRequireDefault(_inherits2);

    var _babelHelperFunctionName = require("chart-1$babel-helper-function-name");
