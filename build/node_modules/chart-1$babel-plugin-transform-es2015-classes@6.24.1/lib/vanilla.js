...
Liferay.Loader.define("chart-1$babel-plugin-transform-es2015-classes@6.24.1/lib/vanilla", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/get-iterator', 'chart-1$babel-runtime/helpers/classCallCheck', 'chart-1$babel-traverse', 'chart-1$babel-helper-replace-supers', 'chart-1$babel-helper-optimise-call-expression', 'chart-1$babel-helper-define-map', 'chart-1$babel-template', 'chart-1$babel-types'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _babelTraverse = require("chart-1$babel-traverse");

    var _babelHelperReplaceSupers = require("chart-1$babel-helper-replace-supers");

    var _babelHelperReplaceSupers2 = _interopRequireDefault(_babelHelperReplaceSupers);

    var _babelHelperOptimiseCallExpression = require("chart-1$babel-helper-optimise-call-expression");

    var _babelHelperOptimiseCallExpression2 = _interopRequireDefault(_babelHelperOptimiseCallExpression);

    var _babelHelperDefineMap = require("chart-1$babel-helper-define-map");

    var defineMap = _interopRequireWildcard(_babelHelperDefineMap);

    var _babelTemplate = require("chart-1$babel-template");
