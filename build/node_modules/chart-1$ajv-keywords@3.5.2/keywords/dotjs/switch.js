...
Liferay.Loader.define('chart-1$ajv-keywords@3.5.2/keywords/dotjs/switch', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    module.exports = function generate_switch(it, $keyword, $ruleType) {
      ...
      out += '' + $closingBraces + 'var ' + ('valid' + $lvl) + ' = ' + $nextValid + ';';
      return out;
    };
  }
});
