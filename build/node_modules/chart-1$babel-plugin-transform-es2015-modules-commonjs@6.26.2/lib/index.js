...
Liferay.Loader.define("chart-1$babel-plugin-transform-es2015-modules-commonjs@6.26.2/lib/index", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/object/keys', 'chart-1$babel-runtime/core-js/object/create', 'chart-1$babel-runtime/core-js/get-iterator', 'chart-1$babel-runtime/core-js/symbol', 'chart-1$path', 'chart-1$babel-template', 'chart-1$babel-plugin-transform-strict-mode', 'chart-1$babel-types'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _symbol = require("chart-1$babel-runtime/core-js/symbol");
    ...
    var _path2 = require("chart-1$path");

    var _babelTemplate = require("chart-1$babel-template");

    var _babelTemplate2 = _interopRequireDefault(_babelTemplate);

    var _babelPluginTransformStrictMode = require("chart-1$babel-plugin-transform-strict-mode");
