Liferay.Loader.define("chart-1$regenerator-transform@0.10.1/src/emit", ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    Ep.clearPendingException = function (tryLoc, assignee) {
      ...
      let catchCall = t.callExpression(this.contextProperty("catch", true), [tryLoc]);
      ...
      switch (expr.type) {
        ...
        case "YieldExpression":
          ...
          if (arg && expr.delegate) {
            ...
            self.emit(t.returnStatement(t.callExpression(self.contextProperty("delegateYield"), [arg, t.stringLiteral(result.property.name), after])));
