...
Liferay.Loader.define("chart-1$regenerator-transform@0.10.1/src/visit", ['module', 'exports', 'require', 'chart-1$private'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    const getMarkInfo = require("chart-1$private").makeAccessor();
