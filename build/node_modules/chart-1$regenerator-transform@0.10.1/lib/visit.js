...
Liferay.Loader.define("chart-1$regenerator-transform@0.10.1/lib/visit", ['module', 'exports', 'require', 'chart-1$assert', 'chart-1$babel-types', './hoist', './emit', './replaceShorthandObjectMethod', './util', 'chart-1$private'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var getMarkInfo = require("chart-1$private").makeAccessor();
