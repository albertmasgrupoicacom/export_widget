...
Liferay.Loader.define("chart-1$regenerator-transform@0.10.1/lib/emit", ['module', 'exports', 'require', 'chart-1$babel-runtime/core-js/json/stringify', 'chart-1$assert', 'chart-1$babel-types', './leap', './meta', './util'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _assert = require("chart-1$assert");
