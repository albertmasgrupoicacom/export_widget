Liferay.Loader.define('chart-1$chart.js@3.9.1/dist/chart', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    (function (global, factory) {
      ...
      var animator = new class Animator {
        constructor() {
          this._request = null;
      ...
      var defaults = new class Defaults {
      ...
      function getNearestRadialItems(chart, position, axis, useFinalPosition) {
        ...
        evaluateInteractionItems(chart, axis, position, function evaluationFunc(element, datasetIndex, index) {
      ...
      class DatasetController {
        ...
        parsePrimitiveData(meta, data, start, count) {
          ...
          for (i = 0, ilen = count; i < ilen; ++i) {
            index = i + start;
            parsed[i] = {
              [iAxis]: iScale === vScale || iScale.parse(labels[index], index),
        ...
        _resolveElementOptions(elementType, mode = 'default', index) {
          ...
          const values = config.resolveNamedOptions(scopes, names, () => this.getContext(index, active), prefixes);
          if (values.$shared) {
      ...
      var registry = new class Registry {
        constructor() {
      ...
      function parseArrayOrPrimitive(meta, data, start, count) {
        ...
        for (i = start, ilen = start + count; i < ilen; ++i) {
          entry = data[i];
          item = {};
          item[iScale.axis] = iScale === vScale || iScale.parse(labels[i], i);
      ...
      class BarController extends DatasetController {
        ...
        updateElements(bars, start, count, mode) {
          ...
          for (let i = start; i < start + count; i++) {
            ...
            const vpixels = mode === 'reset' || isNullOrUndef(parsed[vScale.axis]) ? { base, head: base } : this._calculateBarValuePixels(i);
      ...
      function minMaxDecimation(data, start, count, availableWidth) {
        ...
        for (i = start; i < start + count; ++i) {
          point = data[i];
          x = (point.x - xMin) / (xMax - xMin) * availableWidth;
          y = point.y;
          const truncX = x | 0;
          if (truncX === prevX) {
            if (y < minY) {
            ...
            if (!isNullOrUndef(minIndex) && !isNullOrUndef(maxIndex)) {
              ...
              if (intermediateIndex1 !== startIndex && intermediateIndex1 !== lastIndex) {
                decimated.push(_extends({}, data[intermediateIndex1], {
                  x: avgX
                }));
              }
              if (intermediateIndex2 !== startIndex && intermediateIndex2 !== lastIndex) {
                decimated.push(_extends({}, data[intermediateIndex2], {
                  x: avgX
                }));
              }
            }
      ...
      function fill(ctx, cfg) {
        ...
        for (const _ref2 of segments) {
          const { source: src, target: tgt, start, end } = _ref2;
      ...
      class Legend extends Element {
        ...
        _fitCols(titleHeight, fontSize, boxWidth, itemHeight) {
          ...
          this.legendItems.forEach((legendItem, i) => {
            const itemWidth = boxWidth + fontSize / 2 + ctx.measureText(legendItem.text).width;
            if (i > 0 && currentColHeight + itemHeight + 2 * padding > maxHeight - titleHeight) {
        ...
        _draw() {
          ...
          const drawLegendBox = function (x, y, legendItem) {
            ...
            if (labelOpts.usePointStyle) {
              ...
              drawPointLegend(ctx, drawOptions, centerX, y + halfFontSize, labelOpts.pointStyleWidth && boxWidth);
            } else {
      ...
      class CategoryScale extends Scale {
        ...
        init(scaleOptions) {
          ...
          if (added.length) {
            ...
            for (const _ref3 of added) {
              const { index, label } = _ref3;
