...
Liferay.Loader.define("chart-1$schema-utils@2.7.1/dist/validate", ['module', 'exports', 'require', './keywords/absolutePath', './ValidationError', 'chart-1$ajv', 'chart-1$ajv-keywords'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    const Ajv = require("chart-1$ajv");

    const ajvKeywords = require("chart-1$ajv-keywords");
