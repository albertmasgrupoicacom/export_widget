...
Liferay.Loader.define('chart-1$ajv@6.12.6/scripts/compile-dots', ['module', 'exports', 'require', 'chart-1$glob', 'chart-1$fs', 'chart-1$path', 'chart-1$dot', 'chart-1$js-beautify'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var glob = require('chart-1$glob'),
        fs = require('chart-1$fs'),
        path = require('chart-1$path'),
        doT = require('chart-1$dot'),
        beautify = require('chart-1$js-beautify').js_beautify;
