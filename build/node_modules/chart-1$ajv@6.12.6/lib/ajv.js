...
Liferay.Loader.define('chart-1$ajv@6.12.6/lib/ajv', ['module', 'exports', 'require', './compile', './compile/resolve', './cache', './compile/schema_obj', 'chart-1$fast-json-stable-stringify', './compile/formats', './compile/rules', './data', './compile/util', './compile/async', './keyword', './compile/error_classes', './refs/data.json', './refs/json-schema-draft-07.json'], function (module, exports, require) {
