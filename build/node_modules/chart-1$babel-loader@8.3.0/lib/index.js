...
Liferay.Loader.define("chart-1$babel-loader@8.3.0/lib/index", ['module', 'exports', 'require', '@chart-1$babel/core', '../package.json', './cache', './transform', './injectCaller', './schema', 'chart-1$path', 'chart-1$loader-utils', 'chart-1$schema-utils'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    let babel;
    try {
      babel = require("@chart-1$babel/core");
    } catch (err) {
    ...
    const {
      isAbsolute
    } = require("chart-1$path");
    const loaderUtils = require("chart-1$loader-utils");
    const validateOptions = require("chart-1$schema-utils");
