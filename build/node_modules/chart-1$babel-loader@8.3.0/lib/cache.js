...
Liferay.Loader.define("chart-1$babel-loader@8.3.0/lib/cache", ['module', 'exports', 'require', 'chart-1$fs', 'chart-1$os', 'chart-1$path', 'chart-1$zlib', 'chart-1$crypto', 'chart-1$find-cache-dir', 'chart-1$util', './transform', 'chart-1$make-dir'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    const os = require("chart-1$os");
    const path = require("chart-1$path");
    const zlib = require("chart-1$zlib");
    const crypto = require("chart-1$crypto");
    const findCacheDir = require("chart-1$find-cache-dir");
    const {
      promisify
    } = require("chart-1$util");
