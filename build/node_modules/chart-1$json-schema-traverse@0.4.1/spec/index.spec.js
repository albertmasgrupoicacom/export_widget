...
Liferay.Loader.define('chart-1$json-schema-traverse@0.4.1/spec/index.spec', ['module', 'exports', 'require', '../index', 'chart-1$assert', './fixtures/schema'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var traverse = require('../index');
    var assert = require('chart-1$assert');
