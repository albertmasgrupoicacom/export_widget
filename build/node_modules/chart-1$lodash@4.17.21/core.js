Liferay.Loader.define('chart-1$lodash@4.17.21/core', ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    (function () {
       ...
       */
      var escapeHtmlChar = function basePropertyOf(object) {
        return function (key) {
          return object == null ? undefined : object[key];
        };
      }({
      ...
      function createPartial(func, bitmask, thisArg, partials) {
        ...
        function wrapper() {
          ...
          return fn.apply(bitmask & WRAP_BIND_FLAG ? thisArg : this, args);
        }
        return wrapper;
      }
      ...
      function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
        ...
        if (arrLength != othLength && !(bitmask & COMPARE_PARTIAL_FLAG && othLength > arrLength)) {
          return false;
        }
      ...
      function indexOf(array, value, fromIndex) {
        ...
        while (++index < length) {
          ...
          if (value === value ? other === value : other !== other) {
            return index;
          }
        }
        return -1;
       ...
       */
      var find = function createFind(findIndexFunc) {
      ...
      var bind = baseRest(function (func, thisArg, partials) {
        return createPartial(func, WRAP_BIND_FLAG | 32, thisArg, partials);
      });
       ...
       * // => { 'a': 1, 'c': 3 }
       */
      var pick = function flatRest(func) {
      ...
      lodash.bind = bind;
      lodash.chain = function chain(value) {
      ...
      lodash.mixin = mixin;
      lodash.negate = function negate(predicate) {
      ...
      lodash.sortBy = function sortBy(collection, iteratee) {
        var index = 0;
      ...
      lodash.thru = function thru(value, interceptor) {
        return interceptor(value);
      };
      lodash.toArray = function toArray(value) {
      ...
      lodash.isDate = function baseIsDate(value) {
      ...
      lodash.isRegExp = function baseIsRegExp(value) {
      ...
      lodash.last = function last(array) {
        var length = array == null ? 0 : array.length;
