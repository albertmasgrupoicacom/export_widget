Liferay.Loader.define("chart-1$lodash@4.17.21/core.min", ['module', 'exports', 'require'], function (module, exports, require) {
  ...
  var global = window;
  {
    (function () {
      function n(n) {
        ...
        function e() {
          for (var o = -1, i = arguments.length, c = -1, f = r.length, a = Array(f + i), l = this && this !== on && this instanceof e ? u : n; ++c < f;) a[c] = r[c];for (; i--;) a[c++] = arguments[++o];return l.apply(t, a);
        }if (typeof n != "function") throw new TypeError("Expected a function");
        var u = F(n);return e;
        ...
        var e = null == n ? 0 : n.length;r = typeof r == "number" ? 0 > r ? jn(e + r, 0) : r : 0, r = (r || 0) - 1;for (; ++r < e;) {
          var o = n[r];if (t === t ? o === t : o !== o) return r;
        }return -1;
      }function z(n, t) {
        return mn(n, g(t));
      }function C(n, t, r) {
      ...
      var mn = function (n, t) {
        ...
        }for (r && (u = 1); ++e < u;) for (o = t[e], r = D(o), i = -1, c = r.length; ++i < c;) {
          var f = r[i],
        ...
        return (null == n ? 0 : n.length) ? p(n, 1 / 0) : [];
