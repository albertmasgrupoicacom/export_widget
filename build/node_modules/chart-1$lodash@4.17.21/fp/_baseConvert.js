Liferay.Loader.define('chart-1$lodash@4.17.21/fp/_baseConvert', ['module', 'exports', 'require', './_mapping', './placeholder'], function (module, exports, require) {
      ...
      function cloneByPath(object, path) {
        ...
        while (nested != null && ++index < length) {
          ...
          if (value != null && !(isFunction(value) || isError(value) || isWeakMap(value))) {
            nested[key] = clone(index == length - 1 ? value : Object(value));
          }
          nested = nested[key];
        }
        return result;
